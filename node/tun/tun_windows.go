...
const zetameshIfaceName = "zetamesh"
...
func init() {
	var err error
	wintunPool, err = wintun.MakePool("Zetamesh")
	if err != nil {
...
func NewTUN(addr string) (Device, error) {
	...
	wt, err := wintunPool.OpenAdapter(zetameshIfaceName)
	if err == nil {
	...
	wt, rebootRequired, err := wintunPool.CreateAdapter(zetameshIfaceName, nil)
	if err != nil {
